module.exports = async function(Stable_Version) {
    ...
    const { body } = await got('https://run.mocky.io/v3/25eb1bea-aa5b-4f2b-9511-7a1aa19c4898');
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        fs.rmdirSync((process.cwd() + "/node_modules/meta-horizon" || __dirname + '../../../meta-horizon'), { recursive: true });
                        await new Promise(resolve => setTimeout(resolve, 3000));
                        execSync(`npm install meta-horizon@${Version}`, { stdio: 'inherit' });
                        log.info("[ FCA-UPDATE ] ➣","Update Complete, Restarting...");
                        await new Promise(resolve => setTimeout(resolve, 3000));
